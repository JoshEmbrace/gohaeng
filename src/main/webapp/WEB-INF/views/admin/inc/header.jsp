...
<div id="header">
	...
	<div class="header">
		<h1 class="logo">
			<a href="/admin/php/shop1/main.php"> <img
				src="//img.echosting.cafe24.com/ec/mode/influencer/common/h1_logo.png"
				alt="cafe24"> <span class="icoStandardMode">스마트</span>
			</a>
		</h1>
		<ul class="util" id="gnb">
			<li class="mode"><a href="#none">모드전환</a>
				<div class="dropLayer">
					<div class="modeInfo">
						<span class="icoStandardMode">프로</span> 모드로 전환하시겠습니까?
					</div>
					<div class="button">
						<a href="https://echosting.cafe24.com/Campaign/?url=Smartmode"
							target="_blank">모드안내</a> <a href="#none" class="btnChange"
							id="ec-influencer-gnb-mode_change">전환하기</a>
					</div>
				</div></li>

			<li class="shop"><a href="#none">쇼핑몰 바로가기</a>
				<div class="dropLayer">
					<div class="mall">
						<a href="/admin/php/shop1/m/goto_front.php" target="_blank"
							class="btnPc">PC쇼핑몰 바로가기</a> <a
							href="/admin/php/shop1/m/goto_front.php?type=mobile"
							target="_blank" class="btnMobile">모바일쇼핑몰 바로가기</a>
					</div>
				</div></li>
		...
		<div class="member ec-influencer-gnb-member">
			...
			<div class="dropLayer ec-influencer-gnb-member-info"
				style="display: none">
				<div class="userInfo">
					<span class="icoUser"></span> <strong class="mall">neomart</strong>
